...
from config import SECRET_KEY, ALGORITHM, ACCESS_TOEKN_EXPIRE_MINUTES
...
class JWTBearer(HTTPException):
    ...
    async def __call__(self, request:Request):
        ...
        if credentials:
            ...
            raise HTTPException(status_code=403, detail={"status":"Forbidden", "message":"Invalid authentication code."})
